...
allButton.addEventListener('click,( => populationDOM(people)')
mainHeader.appendChild(allButton)

const maleButton = document.createElement('button')
maleButton.textContent = "Male Characters"
maleButton.addEventListener('click,( => populationDOM(maleCharacters)')
...
const otherCharacters = people.filter((person) => {
    if(
        person.gender ==='n/a' || person.gender === 'hermaprhodite'|| person.gender === 'none') { return person
        }
})
